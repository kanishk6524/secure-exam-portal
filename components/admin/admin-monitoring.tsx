...
type Session = { id: string; examId: string; serverEndsAt: string; user: { id: string; fullName: string; email: string }; exam: { id: string; title: string }; incidents: Array<{ id: string; type: string; severity: string; createdAt: string }>; incidentCount: number }
type LiveIncident = { id: string; sessionId: string; examId: string; type: string; severity: string; createdAt: string }
